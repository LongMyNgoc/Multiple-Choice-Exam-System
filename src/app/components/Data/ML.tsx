...
import { quizML } from "@/app/lib/data/ML";
...
const ML = () => {
  ...
  return (
    <div className="container py-5">
      <h2 className="mb-5 fw-bold text-primary">🧠 Đề thi trắc nghiệm: Học Máy</h2>

      {quizML.map((question: QuizQuestion) => (
      ...
      {!submitted ? (
        ...
        <div className="alert alert-success mt-4 fs-5 fw-bold" role="alert">
          ✅ Bạn đã làm đúng {getScore()} / {quizML.length} câu.
        </div>
      )}
    </div>
  );
