...
import { quizAI } from "@/app/lib/data/AI";
...
const AI = () => {
  ...
  return (
    <div className="container py-5">
      <h2 className="mb-5 fw-bold text-primary">🧠 Đề thi trắc nghiệm: Trí Tuệ Nhân Tạo</h2>

      {quizAI.map((question: QuizQuestion) => (
      ...
      {!submitted ? (
        ...
        <div className="alert alert-success mt-4 fs-5 fw-bold" role="alert">
          ✅ Bạn đã làm đúng {getScore()} / {quizAI.length} câu.
        </div>
      )}
    </div>
  );
